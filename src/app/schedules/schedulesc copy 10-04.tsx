...
const SchedulesC: React.FC<SchedulesCProps> = ({ ResMap }) => {
  ...
  var displayRowMap = new Map<String, DisplayRowType>();
  var row: DisplayRowType;
  ...
  var displayArr = Array.from(displayRowMap.values());
  ...
  const [reportType, setReportType] = React.useState("Grid");
  return (
        ...
        <CardBody>
          <ul className="flex flex-wrap justify-left items-start space-x-4 ">
            <li className="min-w-[50px] py-2">
              ...
              <Select
                isRequired
                classNames={{ innerWrapper: "max-w-[200px] bg-blue-200" }}
            ...
            <div className="bg-white">
              ...
              {reportType == "Grid" && (
                <SchedulesCGrid
                  ...
                  filterCols={[
                    ...["Dt"],
                    ...tCourts.filter((str) => !selectedCourts.includes(str)),
                  ]}
              ...
              {/*}
              <div
                className="ag-theme-alpine min-w-32 "
                style={{ height: 350, width: "100%" }}
              >
                <AgGridReact
                  rowData={rowData.filter(
                    (row) => row.Dt == cDateToString(dtValue)
                  )}
